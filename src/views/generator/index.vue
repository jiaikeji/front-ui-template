  ...
  <div class="app-container">
    <div style="margin: 10px 0px;">
      <el-radio-group v-model="codeType">
        <el-radio-button label="后端生成" />
        <el-radio-button label="前端生成" />
      </el-radio-group>
    </div>
    <template v-if="codeType === '后端生成'">
      <!--工具栏-->
...
<script>
import PageRenderEngine from '@/components/TsComponents/PageRenderEngine/index.vue'
...
export default {
  name: 'GeneratorIndex',
  components: { PageRenderEngine, pagination, crudOperation, rrOperation },
  cruds() {
